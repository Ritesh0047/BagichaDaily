...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Thank you! We\'ll get back to you soon. For immediate orders, please WhatsApp us.');
  };
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-orchard-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white border border-orchard-100">
                ...
                <div>
                  ...
                  <p className="font-medium text-orchard-800">Shimla, Himachal Pradesh</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-orchard-100">
            <h3 className="font-semibold text-lg text-orchard-800 mb-6">Send a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-xl border border-orchard-200 focus:ring-2 focus:ring-orchard-500 focus:border-orchard-500 outline-none"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                className="w-full px-4 py-3 rounded-xl border border-orchard-200 focus:ring-2 focus:ring-orchard-500 focus:border-orchard-500 outline-none resize-none"
              />
              <button
                type="submit"
                className="w-full py-3 bg-orchard-600 text-white font-medium rounded-xl hover:bg-orchard-700 transition-colors"
              >
                Send Message
              </button>
            </form>
